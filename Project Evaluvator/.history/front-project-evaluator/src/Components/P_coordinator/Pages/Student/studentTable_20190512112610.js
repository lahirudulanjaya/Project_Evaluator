...
return(
  ...
  <div className="row">
    ...
    <Dropdown style={{width:'150px'}} placeholder='project' search selection options={Projectnames} defaultValue=""  onChange={this.onchangeDropdown} onClick={this.onclick} disabled={this.state.disable}/>
