...
return(
  ...
  <div className="row">
    ...
    <Dropdown style={{width:'250px'}} placeholder='project' search selection options={Projectnames} defaultValue=""  onChange={this.onchangeDropdown} onClick={this.onclick} disabled={this.state.disable}/>
