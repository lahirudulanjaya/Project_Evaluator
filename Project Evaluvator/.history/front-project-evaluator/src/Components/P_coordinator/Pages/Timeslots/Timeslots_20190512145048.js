    ...
    render() {
        ...
        return (
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-4 text-left" style={{alignItems:'right'}}>Select the project</div>
                ...
                <div className="row">
                    <div className="col-md-4" style={{alignContent:'right'}}>Select the Presentation</div>
                    <div className="col-md-4">
